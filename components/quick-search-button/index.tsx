...
import { PageSectionScroller } from "@/components/page-container";
  ...
  return (
    <PageSectionScroller>
      <Link
        ...
        className={
          "border-border bg-card-background flex shrink-0 items-center justify-center gap-3 rounded-3xl border px-4 py-2"
        }
      >
